...
from tayf_auth.forms import CustomUserCreationForm, AuthForm, PasswordResetForm
from tayf_auth.models import CustomUser, UserToken
from tayf_auth.schemas import RegisterSchema, UserAuthSchema, ErrorMessage, LoginSchema, \
...
@router.post('/register', response={200: UserAuthSchema, 400: ErrorMessage})
...
def reset_password(request, payload: ResetPasswordSchema):
    ...
    if reset_form.is_valid():
        reset_form.save(from_email=settings.EMAIL_HOST_USER, request=request)
